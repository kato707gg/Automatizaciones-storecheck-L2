...
def _load_bridge_from_config_file() -> McpChromeBridge | None:
    ...
    Formato:
    {
      "bridge": "core.creador_de_tareas.mcp_bridge_runtime:EnvCallableMcpChromeBridge",
    ...
    if not bridge_ref:
        bridge_ref = "core.creador_de_tareas.mcp_bridge_runtime:EnvCallableMcpChromeBridge"
