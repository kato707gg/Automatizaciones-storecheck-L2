...
files = sorted(glob.glob(r"C:\Users\katoH\Downloads\Matriz_FIX2_*.xlsx"))
path = files[-1]
print("FILE", path)
...
ws_orig = load_workbook(r"C:\Users\katoH\Downloads\MATRIZ DE CATALOGACÓN actual 1 (4) (1) - copia.xlsx", data_only=False)["CONFIGURACIÓN DE ANAQUEL"]
